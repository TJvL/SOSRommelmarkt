...
//            echo $uploadPath;
    ...
    {
    	NewsRepository::insert($_POST["heading"], $_POST["content"], $_POST["expiration_date"]);
    ...
    public function news_GET()
    {
        if (isset($_GET["id"]))
        {
            $this->render("news", NewsRepository::selectById($_GET["id"]));
        }
    }
    ...
    public function news_POST()
    {
        ...
        if (isset($_GET["id"]))
        {
            if ($_GET["id"] == "delete")
            {
                ...
                {
                    // Delete the module.
                    NewsRepository::deleteById($_POST["id"]);
            ...
            else if ($_GET["id"] == "update")
            {
                ...
                if (isset($_POST["id"]) && isset($_POST["heading"]) && isset($_POST["content"]) && isset($_POST["create_date"]) && isset($_POST["expiration_date"]))
                {
                    ...
                    $news					= NewsRepository::selectById($_POST["id"]);
