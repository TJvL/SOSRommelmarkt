			...
			<div class="col-sm-12">
				<div class="list-group">
					<a class="list-group-item">
						<h4 class="list-group-item-heading">Het Simon</h4>
						<p class="list-group-item-text">Gewoon een baas dit bedrijf</p>
						<div class="collapse">
							<table class="table table-condensed">
								<tbody>
									...
									<tr>
										...
										<td>Gewoon een baas dit bedrijf</td>
									</tr>
								</tbody>
							</table>
							<div class="row">
					...
					<a class="list-group-item collapse-group">
						<h4 class="list-group-item-heading">J. Janssen</h4>
						<p class="list-group-item-text">Subsidieaanvraag preview tekst ofzo.</p>
						<div class="collapse">
							<table class="table table-condensed">
								<tbody>
									<tr>
